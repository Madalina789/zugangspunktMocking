...
public class ZugangspunktTest2 {
    //Wie sehr lohnt sich ein builder wenn ich schon meine SetUp Methode habe?
    ...
    void setUp() {
        ...
        zp= new ZugangspunktBuilder().addNetwork(net).addScanner(scanner).addBerechtigtePersonen(berechtigtePersonen).addDB(db).build();
